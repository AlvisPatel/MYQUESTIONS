                        ...
                        <ul class="navbar-nav my-lg-0">
                            <li class="nav-item dropdown" style="margin-right: 5px;">
                                <a class="nav-link  text-muted waves-effect waves-dark" href="Profile.php">
                                		<?php
                                			$u_id=$_SESSION['u_id'];
											$str="select u_name,u_photo_path from users_details where u_id= $u_id ";
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="update.php " method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="u_name" value=<?php  echo $user_name?> class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
